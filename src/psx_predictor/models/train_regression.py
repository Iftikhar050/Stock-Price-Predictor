...
def train_and_evaluate():
    ...
    plt.plot(pd.to_datetime(dates_test), predictions, label='Predicted Close Price', color='orange', alpha=0.7)
    plt.title(f"{ticker} - Linear Regression Price Prediction (Test Set)")
    plt.xlabel('Date')
