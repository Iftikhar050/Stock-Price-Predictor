...
## All-NaN in every ticker (0)


## Constant (non-NaN) in every ticker (75)
...
- `total_deposits`
- `trade_deficit`
- `trade_deficit_expected`
- `trade_deficit_surprise`
- `trade_deficit_usd_m`
- `wheat_procurement_mt`
- `wpi_index`

## Partially dead - real for some tickers, KEEP (201)

- `acquisition_event` (dead in 106/107 tickers)
- `article_count` (dead in 72/107 tickers)
- `asset_growth` (dead in 80/107 tickers)
...
- `dax_close` (dead in 12/107 tickers)
- `dax_return_pct` (dead in 9/107 tickers)
- `days_since_dividend` (dead in 8/107 tickers)
- `debt_to_equity` (dead in 24/107 tickers)
- `dividend_event` (dead in 58/107 tickers)
- `dividend_yield` (dead in 8/107 tickers)
- `earnings_event` (dead in 1/107 tickers)
- `ebitda` (dead in 34/107 tickers)
- `election_flag` (dead in 2/107 tickers)
- `eps_consensus_surprise` (dead in 2/107 tickers)
- `eps_expected` (dead in 2/107 tickers)
- `eps_growth_yoy` (dead in 3/107 tickers)
- `eps_qoq_surprise` (dead in 2/107 tickers)
- `eps_trailing` (dead in 2/107 tickers)
- `ev` (dead in 1/107 tickers)
- `ev_ebitda` (dead in 34/107 tickers)
- `ev_sales` (dead in 8/107 tickers)
- `event_sentiment_decay` (dead in 59/107 tickers)
- `event_sentiment_score` (dead in 59/107 tickers)
- `fatf_greylist_flag` (dead in 1/107 tickers)
- `fipi_foreign_corporate_net` (dead in 2/107 tickers)
- `fipi_foreign_individual_net` (dead in 2/107 tickers)
- `fipi_overseas_pakistani_net` (dead in 2/107 tickers)
- `forward_pe` (dead in 4/107 tickers)
- `free_cash_flow` (dead in 20/107 tickers)
- `ftse_close` (dead in 12/107 tickers)
- `ftse_return_pct` (dead in 9/107 tickers)
...
- `gross_profit_margin` (dead in 27/107 tickers)
- `imf_gdp_usd_billions` (dead in 1/107 tickers)
- `insider_transaction_event` (dead in 60/107 tickers)
- `inventory` (dead in 38/107 tickers)
- `lipi_banks_net` (dead in 2/107 tickers)
- `lipi_companies_net` (dead in 2/107 tickers)
- `lipi_individuals_net` (dead in 2/107 tickers)
- `lipi_insurance_net` (dead in 2/107 tickers)
- `lipi_mutual_funds_net` (dead in 2/107 tickers)
- `litigation_event` (dead in 106/107 tickers)
- `macro_news_sentiment_count` (dead in 1/107 tickers)
- `management_change_event` (dead in 60/107 tickers)
- `market_cap` (dead in 1/107 tickers)
- `merger_event` (dead in 105/107 tickers)
- `middle_east_conflict_flag` (dead in 2/107 tickers)
- `msci_fm_close` (dead in 1/107 tickers)
- `net_income` (dead in 2/107 tickers)
- `net_profit_margin` (dead in 9/107 tickers)
- `news_sentiment_daily` (dead in 101/107 tickers)
- `news_shock_flag` (dead in 72/107 tickers)
- `news_shock_sentiment` (dead in 104/107 tickers)
- `news_volume_daily` (dead in 72/107 tickers)
- `news_volume_zscore_20d` (dead in 72/107 tickers)
...
- `pe_1y_avg` (dead in 2/107 tickers)
- `pe_3y_avg` (dead in 2/107 tickers)
- `pe_5y_avg` (dead in 2/107 tickers)
- `pe_percentile_1y` (dead in 2/107 tickers)
- `pe_percentile_3y` (dead in 2/107 tickers)
- `pe_ratio` (dead in 2/107 tickers)
- `peg_ratio` (dead in 3/107 tickers)
- `political_news_sentiment_count` (dead in 1/107 tickers)
- `political_uncertainty_score` (dead in 2/107 tickers)
- `price_to_cash_flow` (dead in 25/107 tickers)
- `profit_growth` (dead in 80/107 tickers)
- `profit_margin` (dead in 8/107 tickers)
- `pucars_sentiment_daily` (dead in 48/107 tickers)
- `raw_news_headline_daily` (dead in 83/107 tickers)
...
- `remittances_yoy` (dead in 1/107 tickers)
- `revenue` (dead in 8/107 tickers)
- `revenue_growth` (dead in 81/107 tickers)
- `rights_event` (dead in 106/107 tickers)
- `roa` (dead in 20/107 tickers)
...
- `sent_lag_1` (dead in 47/107 tickers)
- `sent_lag_2` (dead in 47/107 tickers)
- `sent_lag_3` (dead in 47/107 tickers)
- `sentiment_dispersion_7d` (dead in 103/107 tickers)
- `sentiment_momentum_3d_vs_7d` (dead in 103/107 tickers)
- `sentiment_score` (dead in 103/107 tickers)
- `sentiment_score_3d_decay` (dead in 103/107 tickers)
- `sentiment_score_7d_sma` (dead in 103/107 tickers)
- `share_buyback_event` (dead in 105/107 tickers)
- `shares_outstanding` (dead in 71/107 tickers)
- `short_term_speculation_proxy` (dead in 1/107 tickers)
- `sponsor_transaction_event` (dead in 106/107 tickers)
- `steel_price` (dead in 12/107 tickers)
...
- `turnover_ratio` (dead in 1/107 tickers)
- `us5y_yield` (dead in 12/107 tickers)
- `us_yield_curve_2y10y` (dead in 12/107 tickers)
