...
from src.psx_predictor.data.quality_gate import run_quality_checks_all_tickers
...
def main():
    ...
    logger.info("4. Running aggregate data quality summary across all tickers...")
    try:
        run_quality_checks_all_tickers()
    except Exception as e:
        logger.error(f" Error running aggregate quality gate summary: {e}")
